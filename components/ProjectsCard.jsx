...
const ProjectsCard = () => {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border-[1.5px] border-neutral-300 bg-neutral-100 dark:border-neutral-800 dark:bg-neutral-900 p-6">
      <div 
        className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-500 ease-in-out" 
        style={{ 
          opacity: 0, 
          background: 'radial-gradient(circle at 69px 175.438px, rgba(255, 255, 255, 0.25), transparent 80%)' 
        }}
      />
      ...
      <div className="flex flex-col mb-6">
        <Link 
          href="/projects"
          className="bg-neutral-200 rounded-lg w-fit p-3 text-neutral-900 dark:bg-neutral-800 dark:text-neutral-100 hover:opacity-80 transition-opacity mb-4"
        >
          <svg 
            stroke="currentColor" 
            fill="currentColor" 
      ...
      {/* Project screenshots stacked vertically */}
      <div className="flex flex-col gap-3">
        {projects.map((project) => (
          ...
          >
            <div className="rounded-lg overflow-hidden border border-neutral-300 dark:border-neutral-700 bg-neutral-200 dark:bg-neutral-800 hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
