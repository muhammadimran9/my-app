              ...
              <div className="hidden justify-between gap-6 lg:mt-4 lg:flex">
                <div className="flex items-center justify-center">
                  <div className="relative hidden items-center gap-1 rounded-full border-[1.5px] border-neutral-300 bg-neutral-100 p-1 dark:border-neutral-700 dark:bg-neutral-800 lg:flex" style={{width: '94px'}}>
                    <div className="absolute bottom-1 top-1 w-10 rounded-full bg-blue-500" style={{transform: 'none'}}></div>
                    <button 
                    ...
                    >
                      <div className="flex flex-col items-center justify-center text-xs font-medium" style={{color: language === 'AR' ? 'rgb(255, 255, 255)' : 'rgb(115, 115, 115)'}}>
                        AR
                      </div>
                    </button>
                  </div>
