      ...
      <div className="mt-20 p-8 lg:mt-0" data-aos="fade-up">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            ...
            <div className="relative grid w-full grid-cols-[2.5fr_1fr] overflow-hidden rounded-md border-2 border-neutral-700 p-6 md:col-span-2 bg-gradient-to-b from-red-700 to-red-900">
              <div className="text-red-300 z-10 flex flex-col justify-between gap-y-2">
                ...
                <a href="mailto:your.email@example.com" target="_blank" rel="noreferrer" className="bg-red-300 rounded-md bg-opacity-85 px-4 py-2 transition duration-300 hover:scale-105 hover:bg-opacity-100 md:w-max flex items-center gap-x-2 text-slate-800">
            ...
            <div className="relative grid w-full grid-cols-[2.5fr_1fr] overflow-hidden rounded-md border-2 border-neutral-700 p-6 bg-gradient-to-b from-slate-900 to-slate-950">
              <div className="text-slate-400 z-10 flex flex-col justify-between gap-y-2">
                ...
                <a href="https://github.com/" target="_blank" rel="noreferrer" className="bg-slate-400 rounded-md bg-opacity-85 px-4 py-2 transition duration-300 hover:scale-105 hover:bg-opacity-100 md:w-max flex items-center gap-x-2 text-slate-800">
          ...
          <div className="space-y-4">
            <h2 className="text-white">Or send me a message</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 transition-all duration-300">
              <div className="flex w-full flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0">
                <input
                  ...
                  placeholder="Name"
                  required
                  className="w-full rounded-lg bg-neutral-900 p-2 outline outline-neutral-700 focus:outline-neutral-400 text-white"
                />
                <input
                  type="email"
                  name="email"
              ...
              <button
                ...
                className="w-full rounded-lg bg-neutral-600 px-4 py-2 text-neutral-50 shadow-md transition-all duration-300 hover:bg-neutral-700 hover:shadow-lg disabled:bg-neutral-800"
              >
