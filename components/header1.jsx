  ...
  return (
    <header className="lg:w-1/5 lg:pl-5">
      <div className="sticky top-0 z-10 flex flex-col transition-all duration-300 lg:py-8">
        <div className="fixed z-20 w-full bg-neutral-50 p-5 shadow-sm dark:border-b dark:border-neutral-800 dark:bg-neutral-900 lg:relative lg:border-none lg:bg-transparent lg:p-0 lg:shadow-none">
          <div className="flex items-center justify-between md:px-2 lg:flex-col lg:space-y-4">
              ...
              <div className="hidden justify-between gap-6 lg:mt-4 lg:flex">
                <div className="flex items-center justify-center">
                  <div className="relative hidden items-center gap-1 rounded-full border-[1.5px] border-neutral-300 bg-neutral-100 p-1 dark:border-neutral-700 dark:bg-neutral-800 lg:flex" style={{width: '94px'}}>
                    <div className="absolute bottom-1 top-1 w-10 rounded-full bg-blue-500" style={{transform: language === 'US' ? 'none' : 'translateX(40px)'}}></div>
                    <button 
                      className="relative z-10 flex h-8 w-10 items-center justify-center transition duration-200" 
                      tabIndex="0"
                      onClick={toggleLanguage}
                    >
                      <div className="flex flex-col items-center justify-center text-xs font-medium" style={{color: language === 'US' ? 'rgb(255, 255, 255)' : 'rgb(115, 115, 115)'}}>US</div>
                    </button>
                    <button 
                      className="relative z-10 flex h-8 w-10 items-center justify-center transition duration-200" 
                      tabIndex="0"
                      onClick={toggleLanguage}
                    >
                      <div className="flex flex-col items-center justify-center text-xs font-medium" style={{color: language === 'AR' ? 'rgb(255, 255, 255)' : 'rgb(115, 115, 115)'}}>AR</div>
                    </button>
                  </div>
                  <button className="flex items-center gap-2 rounded-full border-[1.5px] border-neutral-300 bg-neutral-100 p-1 transition duration-200 hover:scale-110 dark:border-neutral-700 dark:bg-neutral-800 lg:hidden">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-green-500 text-white">AR</div>
                  </button>
                </div>
                <div className="flex items-center justify-center">
                  <div className="relative hidden items-center gap-2 rounded-full border-[1.5px] border-neutral-300 bg-neutral-100 p-1 dark:border-neutral-700 dark:bg-neutral-800 lg:flex">
                    <div className="absolute bottom-1 top-1 w-8 rounded-full bg-neutral-300 dark:bg-neutral-700" style={{transform: darkMode ? 'translateX(40px)' : 'none'}}></div>
                    <button 
                      className="relative z-10 flex h-8 w-8 items-center justify-center transition duration-200" 
                      aria-label="Switch to light mode" 
                      tabIndex="0"
                      onClick={toggleDarkMode}
                      style={{transform: darkMode ? 'translateX(40px)' : 'none'}}
                    >
                      <div style={{color: darkMode ? 'rgb(255, 255, 255)' : 'rgb(115, 115, 115)'}}>
                    ...
                    <button 
                      ...
                      tabIndex="0"
                      onClick={toggleDarkMode}
                      style={{transform: darkMode ? 'none' : 'none'}}
                    >
                      <div style={{color: darkMode ? 'rgb(255, 255, 255)' : 'rgb(115, 115, 115)'}}>
                        <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 16 16" height="17" width="17" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <button className="flex items-center gap-2 rounded-full border-[1.5px] border-neutral-300 bg-neutral-100 p-1 transition duration-200 hover:scale-110 dark:border-neutral-700 dark:bg-neutral-800 lg:hidden" aria-label="Switch to light mode">
            ...
            <button
              ...
              className="lg:hidden flex items-center justify-center w-10 h-10 rounded-lg bg-neutral-200 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 hover:bg-neutral-300 dark:hover:bg-neutral-700 transition-colors ml-auto"
        ...
        {mobileMenuOpen && (
          <div
            className="lg:hidden fixed inset-0 z-20 bg-slate-800/50 backdrop-blur-sm"
            onClick={() => setMobileMenuOpen(false)}
          />
        )}
        
        {/* Mobile Menu */}
        <div className={`lg:hidden fixed inset-y-0 right-0 z-30 w-64 bg-neutral-50 dark:bg-neutral-900 transform transition-transform duration-300 ease-in-out shadow-xl ${
          ...
          <div className="flex flex-col h-full pt-16 px-5">
            ...
            <div className="flex justify-end mb-4">
              <button
                onClick={() => setMobileMenuOpen(false)}
                className="flex items-center justify-center w-8 h-8 rounded-lg bg-neutral-200 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 hover:bg-neutral-300 dark:hover:bg-neutral-700 transition-colors"
            ...
            <nav className="flex flex-col gap-2">
              <Link href="/" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 py-3 px-4 text-neutral-700 dark:text-neutral-400 hover:text-neutral-900 hover:dark:text-neutral-300 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors">
              ...
              <Link href="/about" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 py-3 px-4 text-neutral-700 dark:text-neutral-400 hover:text-neutral-900 hover:dark:text-neutral-300 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors">
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                  <path d="M12 2a5 5 0 1 0 5 5 5 5 0 0 0-5-5zm0 8a3 3 0 1 1 3-3 3 3 0 0 1-3 3zm9 11v-1a7 7 0 0 0-7-7h-4a7 7 0 0 0-7 7v1h2v-1a5 5 0 0 1 5-5h4a5 5 0 0 1 5 5v1z"></path>
                </svg>
                <span className="text-base font-medium">About</span>
              </Link>
              <Link href="/achievements" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 py-3 px-4 text-neutral-700 dark:text-neutral-400 hover:text-neutral-900 hover:dark:text-neutral-300 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors">
              ...
              <Link href="/projects" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 py-3 px-4 text-neutral-700 dark:text-neutral-400 hover:text-neutral-900 hover:dark:text-neutral-300 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors">
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
              ...
              <Link href="/dashboard" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 py-3 px-4 text-neutral-700 dark:text-neutral-400 hover:text-neutral-900 hover:dark:text-neutral-300 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors">
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
              ...
              <Link href="/chat-room" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 py-3 px-4 text-neutral-700 dark:text-neutral-400 hover:text-neutral-900 hover:dark:text-neutral-300 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors">
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 256 256" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-base font-medium">Chat Room</span>
              </Link>
              <Link href="/contact" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 py-3 px-4 text-neutral-700 dark:text-neutral-400 hover:text-neutral-900 hover:dark:text-neutral-300 rounded-lg hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors">
                <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 24 24" height="20" width="20" xmlns="http://www.w3.org/2000/svg">
              ...
              <Link href="/smart-talk" onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3 py-3 px-4 text-blue-600 dark:text-blue-400 rounded-lg hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors border border-blue-600 dark:border-blue-400">
                ...
                <span className="text-base font-medium">Smart Talk</span>
              </Link>
            </nav>
          </div>
        </div>
        ...
        <div className="hidden md:block">
          ...
          <div className="hidden lg:block">
            <nav className="flex flex-col gap-y-1">
              <a aria-current="page" target="" href="/">
