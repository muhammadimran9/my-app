  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border-[1.5px] border-neutral-800 bg-neutral-900 !p-0 md:col-span-1 flex flex-col from-yellow-400 to-orange-500">
      <div 
        ...
        style={{
          opacity: 0, 
          background: 'radial-gradient(circle at 8px 167.438px, rgba(255, 255, 255, 0.25), transparent 80%)'
        }}
      />
        ...
        <div style={{transform: 'scale(0.8)'}}>
          ...
          >
            ...
            >
              ...
              <div 
                className="absolute bottom-[10%] left-1/2 z-20 w-[85%] h-[75%]" 
                style={{
                  transform: 'translate(-120%, -70%) rotate(-15deg)',
              ...
              >
                <div className="overflow-hidden">
                  <Image
                    alt="Best Team Bangkit Company Track Capstone Project"
                    width={200}
                    height={100}
                    className="duration-700 ease-in-out scale-100 blur-0 grayscale-0 h-full w-full rounded-md object-cover"
                    src="https://yriszutjszdvcsbyjtft.supabase.co/storage/v1/object/public/achievements//best-team-bangkit-company-track-capstone-project.png"
                    unoptimized
                  />
                </div>
              </div>
              ...
              >
                <div className="overflow-hidden">
                  <Image
                    alt="Certificate of Completion Bangkit Academy"
                    width={200}
                    height={100}
                    className="duration-700 ease-in-out scale-100 blur-0 grayscale-0 h-full w-full rounded-md object-cover"
                    src="https://yriszutjszdvcsbyjtft.supabase.co/storage/v1/object/public/achievements//bangkit-academy.png"
                    unoptimized
                  />
                </div>
              </div>
              ...
              >
                <div className="overflow-hidden">
                  <Image
                    alt="Sertifikat Kepesertaan Studi Independen Bersertifikat Angkatan 7"
                    width={200}
                    height={100}
                    className="duration-700 ease-in-out scale-100 blur-0 grayscale-0 h-full w-full rounded-md object-cover"
                    src="/images/achievements/certificates/sertifikat-kepesertaan-studi-independen-bersertifikat-angkatan-7.jpg"
                    unoptimized
                  />
                </div>
              </div>
