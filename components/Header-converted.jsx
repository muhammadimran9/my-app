              ...
              <button className="cursor-pointer transition-transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 dark:focus:ring-offset-neutral-900 rounded-full" aria-label="View profile details">
                <div className="overflow-hidden rounded-full">
                  <img 
                    ...
                    src="https://res.cloudinary.com/dmringwwj/image/upload/v1764442495/hussainwebappdeveloper_ufiaaw.jpg"
                  />
                </div>
              </button>
              <div className="mt-1 flex items-center gap-2 lg:mt-4">
                <Link href="/">
                  <h2 className="grow text-lg arabic-text-lg font-medium lg:text-xl lg:arabic-text-xl">Muhammad Hussain</h2>
                </Link>
